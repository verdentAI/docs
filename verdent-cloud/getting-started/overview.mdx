...
<Steps>
  <Step title="Find inspiration">
    Start from a template or use Taste Mode to turn an idea into an app.
  </Step>
  <Step title="Generate a project">
    Start from a template, or use Taste Mode to turn an idea into an app — either by describing it in the prompt box or by attaching an image/design as reference.
  </Step>
