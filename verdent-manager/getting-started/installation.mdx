...
* **Operating System**: macOS 11+ or Windows 10+ (64-bit). See [Supported Operating Systems](/verdent-manager/getting-started/supported-operating-systems) for full compatibility details.
