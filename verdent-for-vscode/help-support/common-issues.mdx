...
<Tabs>
  <Tab title="Service Errors (Most Common)">
    ...
    **Recovery steps (in order):**
    ...
    <Warning>
      If the issue persists for more than 5-10 minutes across multiple sessions, check the [Verdent status page](https://verdent.ai/status?ots=verdentdoc) or contact [support@verdent.ai](mailto:support@verdent.ai).
    </Warning>
  </Tab>
