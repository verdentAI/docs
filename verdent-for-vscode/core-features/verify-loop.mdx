...
2. **Automatic Use of Subagents and Browser Tools**\
   After understanding your code, Verdent may trigger the _verify subagent_ and _browser tool_ to validate both backend logic and frontend performance. This ensures everything works as expected across different browsers and environments.
