...
<Tabs>
  <Tab title="Balance (Default)">
    - **Cost:** 1x baseline (~140 requests per 100 credits)
  ...
  <Tab title="Efficiency">
    - **Cost:** ~0.3x Balance (70% reduction, ~450 requests per 100 credits)
...
```markdown filename="user_rules.md"
...
|-----------|----------|-------|-----------------|
| User Rules | `~/.verdent/user_rules.md` | All projects | Personal, not shared |
...
```markdown filename="security-reviewer.md"
---
