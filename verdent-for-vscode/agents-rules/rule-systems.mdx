...
- **Plan customization** (plan_rules.md) - Plan Mode output format and content
...
**File Location:** `~/.verdent/plan_rules.md`
...
<CardGroup cols={2}>
  ...
  <Card title="Best Practices: Prompts" icon="message-lines" href="/verdent-for-vscode/best-practices/prompts">
    Writing effective prompts to get the most from Verdent
  </Card>
</CardGroup>
