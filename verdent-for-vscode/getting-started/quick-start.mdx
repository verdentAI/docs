...
2. **Permission request:** In Manual Accept Mode (the default), Verdent asks for your approval before creating the file.
3. **You approve:** Click "Accept" or approve the change.
