...
This quickstart guide will have you using AI-powered coding assistance in under 15 minutes. You'll install the extension, complete your first task, and understand the core code workflow when working with Verdent for VS Code.
...
2. **Permission request**
   In Manual Accept Mode (the default), Verdent asks for your approval before creating the file

3. **You approve**
   Click "Accept" or approve the change
...
|------|-------------|-------------|
| **Manual Accept** (default) | Requests permission on first use of each tool | Learning and general development with maximum control |
| **Auto-Run** | Automatically accepts safe operations (file reads, web searches); file edits and commands still require approval | Trusted projects and rapid prototyping |
