...
Verdent for VS Code uses a sophisticated subagent architecture that intelligently dispatches tasks to specialized subagents. Understanding these core concepts will help you work more effectively with the extension.
...
|----------|-------|----------|------|
| Anthropic | Claude 4.5 Sonnet | Balanced complex tasks | ~140 requests/100 credits |
| Anthropic | Claude 4.5 Sonnet 1M | Long or complex tasks (>200k input) | ~70 requests/100 credits |
| Anthropic | Claude 4.5 Haiku | Fast, simple tasks | ~450 requests/100 credits |
| OpenAI | GPT-5 (Beta) | Reasoning and creativity | ~186 requests/100 credits |
| OpenAI | GPT-5 Codex (Beta) | Coding and debugging | ~186 requests/100 credits |
| Google | Gemini 3 Pro | Advanced reasoning and multimodal | Variable |
| MiniMax | MiniMax M2 (Beta) | Fast and cost-effective | Free until Nov 10th |
...
The usage currency for Verdent. Different models consume different amounts of credits per request. Your subscription includes a monthly credit allotment (e.g., 640 credits for Starter, 2,000 for Pro, 6,000 for Max).
</Accordion>
