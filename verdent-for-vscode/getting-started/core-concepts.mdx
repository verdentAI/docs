...
* **Plan** - See what the AI will do before execution. Clarify requirements with Blueprint's interactive architecture plans, task breakdowns, and visual diagrams, customized through Plan Rules
* **Verify** - Automate quality assurance with Verify Loop. Iterate through multipass repair cycles until code passes comprehensive validation
