...
- **Verify** - Automate quality assurance with Verify subagent and browser action. Iterate through multipass repair cycles until code passes comprehensive validation
