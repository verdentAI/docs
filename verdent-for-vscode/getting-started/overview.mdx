...
* **Plan** - Clarify requirements and design solutions with clear, visual logic diagrams using Blueprint and Clear Mode
* **Verify** - Automate test interactions and catch issues early with dedicated verifier subagents and browser tools through the Verify Loop
