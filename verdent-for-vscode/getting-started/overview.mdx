...
<Note>
  Limited-time 2x bonus active: All plans currently include double credits (320 becomes 640, 1,000 becomes 2,000, 3,000 becomes 6,000). Verdent will provide 15+ days advance notice before this bonus ends. Current plan and model details live in [Credits & Plans](/account-billing/credits-and-plans) and [Model Pricing](/account-billing/model-pricing).
</Note>
