...
Verdent uses a credit-based model starting at $19/month. Credits are shared across both Desktop and VS Code, so one subscription works everywhere. For the current plan lineup and provider-side model pricing references, see [Credits & Plans](/account-billing/credits-and-plans) and [Model Pricing](/account-billing/model-pricing).
</Accordion>
