...
<Accordion title="Rebase to Master">
Process of applying changes from a workspace back into the master branch
</Accordion>

<Accordion title="Sync with Master">
Pull latest changes from master into the current workspace
</Accordion>
