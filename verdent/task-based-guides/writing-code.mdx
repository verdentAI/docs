  ...
  <Tab title="Independent Features">
    ...
    <Steps>
      ...
      <Step title="Rebase to Master">
        Click **Workspace Actions → Rebase to master** to apply changes
      </Step>
    </Steps>
  ...
  <Tab title="Bug Fix + Feature">
    ...
    <Steps>
      ...
      <Step title="Ship the Fix">
        When the fix is ready, click **Workspace Actions → Rebase to master** to ship the fix
      </Step>
  ...
  <Tab title="Experimental">
    ...
    <Steps>
      ...
      <Step title="Keep or Discard">
        If successful, click **Workspace Actions → Rebase to master** to keep changes. If failed, click **Delete Workspace** in the Workspace Bar to discard all changes.
      </Step>
    </Steps>
...
Delete the workspace to discard all changes. Click **Delete Workspace** in the Workspace Bar to remove the workspace and all its modifications. Your base workspace remains unaffected.
</Accordion>
