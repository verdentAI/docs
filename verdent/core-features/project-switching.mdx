...
<CardGroup cols={2}>
  ...
  <Card title="Active Agents" icon="robot">
    Ask Verdent Team: Confirm agent continuation behavior
  </Card>
...
<Warning>
Ask Verdent Team: Details on the maximum number of simultaneous projects needed.
</Warning>
...
- **Let agents work**: Ask Verdent Team: Confirm if agents continue when switching projects
...
| **Memory usage** | Ask Verdent Team: Details on memory consumption per project needed |
...
Ask Verdent Team: Confirm agent continuation behavior when switching projects.
</Accordion>

<Accordion title="Is there a limit to how many projects I can have open?">
Ask Verdent Team: Details on specific limits needed. The system is designed for multi-project workflows with all states preserved.
</Accordion>

<Accordion title="What happens if I close a project with running agents?">
Ask Verdent Team: Confirm behavior when closing projects with active agents.
</Accordion>
...
Project-specific settings are preserved between Verdent sessions. Ask Verdent Team: Confirm conversation and task state persistence behavior.
</Accordion>
