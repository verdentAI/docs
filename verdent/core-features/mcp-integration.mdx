...
Yes. Use `.mcp.json` in project root for project-specific servers, or `~/.verdent/mcp.json` for global servers available across all projects.
</Accordion>
...
<CardGroup cols={2}>
  ...
  <Card title="Integrations" icon="plug" href="/verdent/advanced-features/integrations">
