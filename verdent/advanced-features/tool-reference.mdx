...
Verdent provides a comprehensive toolkit for code manipulation, navigation, and external interaction.
...
<Tabs>
  ...
  <Tab title="Execution & Integration">
    ...
    | `spawn_subagent` | Delegate to specialists | Launch verifier or code-reviewer subagents |
...
<Tabs>
  ...
  <Tab title="Execution & Integration">
    ...
    **Capabilities:**
    ...
    - Types: `verifier`, `code-reviewer`
    - Delegate complex tasks without polluting main context
    - Parallel subagent execution for efficiency

    **Use Cases:**
    - **@Verifier:** Validate implementation logic and syntax
    - **@Code-reviewer:** Security and quality assessment

    **Best Practice:** Delegate research and validation tasks to subagents to preserve main conversation context.
...
<Tabs>
  ...
  <Tab title="Command Execution">
    ...
    **Safe Command Execution:**
    ...
    - Use Plan Mode for review in shared codebases
  ...
  <Tab title="Subagents & Context">
    ...
    **Best Practice:**
    Delegate validation and review tasks to subagents to preserve main conversation context for active development work.
    ...
    **Strategic Tool Usage:**
    ...
    - Use subagents for validation and review
