...
- **Right Panel** - Source Control and Explorer tabs
...
| **User Center** | Account info, credit balance |
...
- Click **User Center** → View credits, account info
...
| **Workspace Actions** | Dropdown with Rebase to master, Sync with master |
...
| **Toggle Explorer and Source Control (Ctrl+B)** | Show/hide right panel |
...
## Right Panel: Source Control & Explorer

The right panel provides file management and version control:
...
**Task Changes** - Click to view all files changed within the current task.
