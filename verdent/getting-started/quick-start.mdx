...
Press `Shift + Tab` or `Ctrl + .`, or click the **Switch Mode** button in the input box
...
| **Rebase to Master** | Apply workspace changes to the master branch |
| **Sync with Master** | Pull latest changes from master into the workspace |
...
<Steps>
  ...
  <Step title="Rebase When Ready">
    When work is complete, use **Workspace Actions** → **Rebase to Master** to apply changes
  </Step>
</Steps>
...
| **Plan Mode** | Read-only planning | Complex features, code review |
...
2. Review changes
3. Use **Workspace Actions** → **Rebase to Master** to apply changes
