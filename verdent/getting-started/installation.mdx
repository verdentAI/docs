...
**[verdent.ai/download](https://verdent.ai/download?ots=verdentdoc)**
...
<Steps>
  <Step title="Download">
    Download the `.dmg` file from [verdent.ai/download](https://verdent.ai/download?ots=verdentdoc)
  </Step>
  <Step title="Open DMG">
...
<Steps>
  <Step title="Download">
    Download the `.exe` installer from [verdent.ai/download](https://verdent.ai/download?ots=verdentdoc)
  </Step>
