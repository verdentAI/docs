...
<Tabs>
  <Tab title="Service Errors (Most Common)">
    ...
    **Recovery steps (in order):**
    ...
    <Warning>
    If the issue persists for more than 5-10 minutes across multiple tasks, check the [Verdent status page](https://verdent.ai/status?ots=verdentdoc) or contact support@verdent.ai.
    </Warning>
  </Tab>
  ...
  <Tab title="Authentication & Account">
    ...
    **Solutions:**
    ...
    4. Verify account status at [verdent.ai/account](https://verdent.ai/account?ots=verdentdoc)
